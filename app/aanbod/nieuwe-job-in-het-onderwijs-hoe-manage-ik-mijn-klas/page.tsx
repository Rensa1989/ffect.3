...
export const metadata = {
  title: "Nieuwe job in het onderwijs: Hoe manage ik mijn klas? - ffect",
  description:
    "Wat ik zeker moet weten om aan de slag te gaan. Praktische tips voor nieuwe leerkrachten om effectief klasmanagement te ontwikkelen.",
}

export default function NieuweJobInHetOnderwijs() {
  const goals = [
    ...
    <div className="bg-white pt-8">
      ...
      <nav className="bg-gray-50 py-4">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Nieuwe job in het onderwijs: Hoe manage ik mijn klas?</span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/nieuwe%20job%20in%20het%20onderwijs_hoe%20manage%20ik%20mijn%20klas.jpg-THdGt6JAw3wgIy0Xax2do53dErt0WO.jpeg"
            alt="Nieuwe job in het onderwijs: Hoe manage ik mijn klas?"
            fill
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
          Nieuwe job in het onderwijs: Hoe manage ik mijn klas?
        </h1>
        <p className="text-xl text-slate-600 mb-8">Wat ik zeker moet weten om aan de slag te gaan</p>
      </section>
