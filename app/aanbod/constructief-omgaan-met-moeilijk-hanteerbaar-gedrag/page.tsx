...
export const metadata = {
  title: "Constructief omgaan met moeilijk hanteerbaar gedrag - ffect",
  description:
    "Grote mond, geen interesse en mijn klas op stelten… Wat doe ik hieraan? Leer praktische strategieën voor gedragsbeheer.",
}

export default function ConstructiefOmgaanMetMoeilijkHanteerbaarGedrag() {
  const goals = [
    ...
    <div className="bg-white pt-8">
      ...
      <nav className="bg-gray-50 py-4">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Constructief omgaan met moeilijk hanteerbaar gedrag</span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/constructief%20omgaan%20met%20moeillijk%20hanteerbaar%20gedrag.jpg-JQCH1xVeHrpjQZz2YqqwsqgqzF5wKB.jpeg"
            alt="Constructief omgaan met moeilijk hanteerbaar gedrag"
            fill
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
          Constructief omgaan met moeilijk hanteerbaar gedrag
        </h1>
        <p className="text-xl text-slate-600 mb-8">
          Grote mond, geen interesse en mijn klas op stelten… Wat doe ik hieraan?
        </p>
      </section>
