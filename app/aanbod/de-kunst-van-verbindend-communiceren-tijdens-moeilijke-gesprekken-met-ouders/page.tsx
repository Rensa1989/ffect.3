...
import { ArrowLeft, Phone, Target, Users } from "lucide-react"

export const metadata = {
  title: "De kunst van verbindend communiceren tijdens moeilijke gesprekken met ouders - ffect",
  description:
    "Oudercontacten en slechtnieuwsgesprek, hoe pak ik dat aan? Leer effectieve communicatiestrategieën voor oudercontacten.",
}

export default function DeKunstVanVerbindendCommuniceren() {
  return (
    <div className="bg-white pt-8">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">
              De kunst van verbindend communiceren tijdens moeilijke gesprekken met ouders
            </span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/de%20kunst%20van%20verbindend%20communiceren%20tijdens%20moeilijke%20gesprekken%20met%20ouders.jpg-zUUh829VTu2KVWJNL8XhUv6Alxd4tF.jpeg"
            alt="De kunst van verbindend communiceren tijdens moeilijke gesprekken met ouders"
            fill
        ...
        <p className="text-xl text-slate-600 mb-8">Oudercontacten en slechtnieuwsgesprek, hoe pak ik dat aan?</p>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              ...
              <div className="bg-white rounded-lg border border-blue-100 p-6 shadow-sm">
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">
                      Je krijgt inzicht in de verschillende fases van de groepsdynamiek en leert hoe, waar en wanneer je
                      wat kan installeren.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">
                      Je bouwt samen met je team een preventiebeleid uit rekening houdend met de verschillende fases van
                      de groepsdynamiek.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">
                      Je kan aan de hand van een stappenplan de groepsdynamiek beïnvloeden op momenten dat het moeilijk
                      loopt in de klas.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white rounded-lg border border-blue-100 p-6 shadow-sm">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">Leerkrachten</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">Directies/middenkader</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">Leerlingbegeleiders</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">Zorgcoördinatoren</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">CLB-medewerkers</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-teal-600 mr-3 mt-1 flex-shrink-0">•</span>
                    <span className="text-base text-slate-700">Leerondersteuners</span>
                  </li>
                </ul>
              </div>
            </div>
