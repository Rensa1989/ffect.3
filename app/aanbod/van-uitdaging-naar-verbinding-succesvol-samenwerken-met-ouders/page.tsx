...
export const metadata = {
  title: "Van uitdaging naar verbinding: succesvol samenwerken met ouders - ffect",
  description:
    "Inzetten op ouderbetrokkenheid en verbindend omgaan met agressie bij ouders. Ontwikkel effectieve samenwerkingsstrategieën.",
}

export default function VanUitdagingNaarVerbinding() {
  const goals = [
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">
              Van uitdaging naar verbinding: succesvol samenwerken met ouders
            </span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/van%20uitdaging%20naar%20verbinding_succesvol%20samenwerken%20met%20ouders.jpg-FZSVouoOZc1VPW7flAsLCdLV2c7WIJ.jpeg"
            alt="Van uitdaging naar verbinding: succesvol samenwerken met ouders"
            fill
        ...
        <p className="text-xl text-slate-600 mb-8">
          Inzetten op ouderbetrokkenheid en verbindend omgaan met agressie bij ouders
        </p>
      </section>
