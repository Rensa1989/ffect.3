...
export default function EenKlasKrijgJeEenGroepMaakJeClient() {
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])
    ...
    <div className="bg-white pt-8">
      ...
      <nav className="bg-gray-50 py-4">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Een klas krijg je, een groep maak je</span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/een%20klas%20krijg%20je%20een%20groep%20maak%20je.jpg-dDUkbsUAplQurIpp5RUfB47xDogqpD.jpeg"
            alt="Veilige klasgroep: preventie, groepsdynamiek en succesvol herstellen"
            fill
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
          Een klas krijg je, een groep maak je
        </h1>
        <p className="text-xl text-slate-600 mb-8">
          Het creëren van een veilige klasgroep: preventie, groepsdynamiek en succesvol herstellen
        </p>
      </section>
