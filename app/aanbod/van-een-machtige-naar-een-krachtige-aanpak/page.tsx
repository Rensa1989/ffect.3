...
export const metadata = {
  title: "Van een machtige naar een krachtige aanpak - ffect",
  description:
    "Introductie in nieuwe autoriteit, geweldloos verzet. Leer positieve autoriteitsstrategieën voor de klas.",
}

export default function VanEenMachtigeNaarEenKrachtigeAanpak() {
  const goals = [
    ...
    <div className="bg-white pt-8">
      ...
      <nav className="bg-gray-50 py-4">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Van een machtige naar een krachtige aanpak</span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/van%20een%20machtige%20naar%20een%20krachtige%20aanpak.jpg-poOsWhmPHxHP5rQg8lOHoLTfR8lV27.jpeg"
            alt="Van een machtige naar een krachtige aanpak"
            fill
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
          Van een machtige naar een krachtige aanpak
        </h1>
        <p className="text-xl text-slate-600 mb-8">Introductie in nieuwe autoriteit, geweldloos verzet</p>
      </section>
