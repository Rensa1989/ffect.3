...
export const metadata = {
  title: "Effectief beleid en constructieve aanpak bij moeilijk hanteerbaar gedrag - ffect",
  description:
    "Een onderbouwd beleid voor een optimale leer-, leef- en werkomgeving. Ontwikkel effectieve strategieën voor gedragsbeheer.",
}

export default function EffectiefBeleidEnConstructieveAanpak() {
  const goals = [
    ...
    <div className="bg-white pt-8">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-gray-900 font-medium">
              Effectief beleid en constructieve aanpak bij moeilijk hanteerbaar gedrag
            </span>
          </div>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 max-w-4xl py-8">
        <div className="relative aspect-video w-full rounded-lg overflow-hidden mb-8">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/effectief%20beleid%20voor%20moeilijk%20hanteerbaar%20gedrag.jpg-VLakj4MvhGgY2kP4LidqBcV5UNfbBO.jpeg"
            alt="Effectief beleid en constructieve aanpak bij moeilijk hanteerbaar gedrag"
            fill
        ...
        <p className="text-xl text-slate-600 mb-8">
          Een onderbouwd beleid voor een optimale leer-, leef- en werkomgeving
        </p>
      </section>
